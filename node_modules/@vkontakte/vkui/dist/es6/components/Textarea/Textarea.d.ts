...
export interface TextareaProps extends TextareaHTMLAttributes<HTMLTextAreaElement>, HasRef<HTMLTextAreaElement>, HasRootRef<HTMLElement>, HasFormStatus {
    grow?: boolean;
...
export default class Textarea extends PureComponent<TextareaProps, TextareaState> {
    ...
    getRef: GetRef<HTMLTextAreaElement>;
    resize: VoidFunction;
