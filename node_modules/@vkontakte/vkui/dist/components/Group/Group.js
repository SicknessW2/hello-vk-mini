...
var Group = function Group(props) {
  ...
  return _react.default.createElement("section", (0, _extends2.default)({}, restProps, {
    ref: getRootRef,
    className: (0, _classNames.default)(baseClassNames, className)
  }), header, children && _react.default.createElement("div", {
    className: "Group__content"
  }, children), description && _react.default.createElement("div", {
    className: "Group__description"
  }, description), separator !== 'hide' && _react.default.createElement(_Separator.default, {
