...
var PanelHeaderBack = function PanelHeaderBack(props) {
  ...
  return _react.default.createElement(_PanelHeaderButton.default, props, platform === _platform.ANDROID ? _react.default.createElement(_back.default, null) : _react.default.createElement(_chevron_back.default, null));
};
